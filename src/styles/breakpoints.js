export const PHONE = "@media (max-width: 769px) and (min-width: 320px)";
export const PHABLET = "@media all and (max-width: 480px)";
...
export const WIDE = "@media all and (min-width: 768px) and (max-width: 1024px)";
